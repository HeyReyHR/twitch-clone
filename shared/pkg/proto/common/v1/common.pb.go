...
type User struct {
	...
	Role          Role                   `protobuf:"varint,4,opt,name=role,proto3,enum=common.v1.Role" json:"role,omitempty"`
...
const file_common_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x16common/v1/common.proto\x12\tcommon.v1\x1a\x1fgoogle/protobuf/timestamp.proto\"\xec\x01\n" +
	"\x04User\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\tR\x06userId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email\x12#\n" +
	"\x04role\x18\x04 \x01(\x0e2\x0f.common.v1.RoleR\x04role\x129\n" +
	"\n" +
