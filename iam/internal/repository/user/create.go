...
func (r *repository) Create(ctx context.Context, email, username string, role repoModel.Role, passwordHash string) (string, error) {
	...
	_, err := r.dbConn.Exec(ctx, "INSERT INTO users (user_id, username, email, role, password_hash, created_at, updated_at) VALUES ($1, $2, $3, $4, $5, $6, $7)", userId, username, email, role, passwordHash, currentTime, currentTime)
	if err != nil {
